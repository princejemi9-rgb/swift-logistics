...
This directory prepares the production PostgreSQL schema. For the Swift Logistics project at `https://lkxbkquzzzxfajyebxob.supabase.co`, run `schema.sql` and then `002_auth_profile_and_public_tracking.sql`, in that order, in the Supabase SQL Editor.
